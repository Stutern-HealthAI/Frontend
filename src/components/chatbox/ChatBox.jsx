...
function ChatBox({style, alias, queryMessage}) {

  return (
    <div className="flex items-center flex-row-reverse gap-8 w-[80%] rounded-2xl my-4 p-2 float-right border border-green-800">
